...
# Example usage:
# python3 pyCascade/pyCascade/inflowProfile.py --n 400 --x -40 --z 0 --y0 0 --y1 30 --rough 0.000005 --UatZ 15 1.07 --Iu 0.1087 --method 'ASCE' --multiply 4 --multiplyuu False --filefmt 'rows' --filename 'inflowProfile_30m_x4.dat'
# python3 pyCascade/pyCascade/inflowProfile.py --n 400 --x -40 --z 0 --y0 0 --y1 30 --rough 0.000005 --UatZ 15 1.07 --Iu 0.1087 --method 'ASCE' --multiply 4 --multiplyuu False --filefmt 'table' --filename 'turbInflowProfile_30m_x4.dat'
